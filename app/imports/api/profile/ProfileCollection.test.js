...
if (Meteor.isServer) {
  describe('ProfileCollection', function testSuite() {
    ...
    const defineObject = {
      firstName, lastName, username, bio, interests, picture, title, location, github, facebook,
      instagram,
    };
    ...
    it('#define (illegal interest)', function test() {
      ...
      const defineObject2 = {
        firstName, lastName, username, bio, interests: illegalInterests, picture, title, location, github, facebook,
        instagram,
      };
      expect(function foo() {
